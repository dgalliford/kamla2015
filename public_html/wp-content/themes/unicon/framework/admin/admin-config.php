    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'description' => __('<strong>PLEASE NOTE:</strong> Only Header 1 can be transparent. Keep that in mind when choosing your Page specific Headers.', 'minti-framework'),
                'options'  => array(
                    'v1'      => array(
                        'alt'   => 'Header 1', 
            ...
            array(
                ...
                'type'      => 'info',
                'desc'      => __('Header-V1, Header-V2 & Mobile Header Settings', 'minti-framework')
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'type'     => 'select',
                'title'    => __('WooCommerce Sidebar Position', 'minti-framework'), 
                'subtitle' => __('WooCommerce Listing Sidebar Position', 'minti-framework'),
                'options'  => array(
