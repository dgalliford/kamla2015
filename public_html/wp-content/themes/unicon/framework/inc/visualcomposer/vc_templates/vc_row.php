...
echo '<div '.$set_row_id.' class="wpb_row vc_row-fluid '. esc_attr($main_class) . esc_attr($parallax_class) . ' '. esc_attr($class) . ' '.esc_attr($bg_stretch_class).'" data-speed="'.esc_attr($stellar_class).'" style="'.$style.'">'; // Don't escape $set_row_id and $style
