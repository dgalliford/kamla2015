...
function minti_grid_elements_menu(){
  remove_menu_page( 'edit.php?post_type=vc_grid_item' );
}
add_action( 'admin_menu', 'minti_grid_elements_menu' );
...
vc_add_param("vc_row", array(
	...
	"group"	=> __( 'General', 'minti-framework' ),
));
...
vc_add_param("vc_column", array(
	...
	"description" => "Usefull if you have Columns with different heights. Note: Only works when the parent row is set to Full-Width.",
	"group"	=> __( 'Background', 'minti-framework' )
));
...
function minti_divider_vc() {
	vc_map( array(
		...
		"description"			=> __( "Divider", 'minti-framework' ),
		"base"					=> "minti_divider",
		'category'				=> "Structure",
	...
	vc_map( array(
		...
		"params"				=> array(
			...
			array(
				...
				"param_name"	=> "content",
				"value"			=> "",
				"description"	=> __( "Use the 'Unordered List' button on the editor to add the Pricing Plan values." ),
			),
		)
	) );
	...
	vc_map( array(
		...
		"params"				=> array(
			...
			array(
				...
				"admin_label"	=> false,
				"class"			=> "",
				"heading"		=> __( "Animation", 'minti-framework' ),
				"param_name"	=> "animation",
				"value"			=> array(
					"None" => "none",
				    "Fade In" => "fade-in",
			...
			array(
				...
				"admin_label"	=> false,
				"class"			=> "",
				"heading"		=> __( "Open Image in Lightbox", 'minti-framework' ),
				"param_name"	=> "lightbox",
				"value"			=> array("Yes, please!" => true ),
			),
			array(
				...
				"param_name"	=> "url",
				"value"			=> "",
				"description"	=> __( "Enter URL (if you want to link the image to a special URL) or leave empty", 'minti-framework' )
			),
		)
	) );
}
