...
class widget_sponsor extends WP_Widget_Text { 
	...
	function widget_sponsor() {
		$widget_ops = array('description' => __('Display your Sponsor Links', 'minti-framework') );
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'sponsor' );
		$this->WP_Widget( 'sponsor', __('minti.Sponsor', 'minti-framework'), $widget_ops, $control_ops );
	}
