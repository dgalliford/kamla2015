...
<div class="sharebox clearfix">
	<ul>
		...
		<li>
			<a href="http://google.com/bookmarks/mark?op=edit&amp;bkmk=<?php the_permalink() ?>&amp;title=<?php echo urlencode(esc_attr(the_title('', '', false))); ?>" target="_blank" class="share-google" title="<?php _e( 'Share via', 'minti' ) ?> <?php _e( 'Google+', 'minti' ) ?>"><i class="fa fa-google-plus"></i> <?php _e( 'Google+', 'minti' ) ?></a>
		</li>
		<?php } ?>
