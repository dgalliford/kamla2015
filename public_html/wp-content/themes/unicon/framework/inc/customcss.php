...
if ( !function_exists( 'minti_dynamic_css' ) ) {
	...
	function minti_dynamic_css() {
		...
		input[type='text'], input[type='password'], input[type='email'], textarea, select { font-family: {$font_body_face}, Arial, Helvetica, sans-serif; font-size: {$font_body_size}; }
		...
		#navigation .sub-menu li a{ border-color: {$color_subnavborder}; }
		...
		a.button,input[type=submit],button{background:{$color_accent};border-color:{$color_accent};}
		...
		.wpb_content_element .wpb_tabs_nav li.ui-tabs-active{border-bottom-color:{$color_accent};}
		...
		.vc_pie_chart h4, .page-404 h3{ font-family: '{$font_specialfont_face}', Arial, Helvetica, sans-serif; /*letter-spacing: {$font_specialfont_spacing}; font-weight: {$font_specialfont_weight};*/}
