...
function minti_widgets_init() {
	...
	if(isset($minti_data['select_footercolumns']) && ($minti_data['select_footercolumns'] == "4")){ $footercolumns = "four"; }
	elseif(isset($minti_data['select_footercolumns']) && ($minti_data['select_footercolumns'] ==  "3")){ $footercolumns = "one-third"; }
	elseif(isset($minti_data['select_footercolumns']) && ($minti_data['select_footercolumns'] ==  "2")){ $footercolumns = "eight"; }
	elseif(isset($minti_data['select_footercolumns']) && ($minti_data['select_footercolumns'] ==  "1")){ $footercolumns = "sixteen"; }
